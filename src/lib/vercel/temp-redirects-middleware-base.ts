// This is a temp base class that reimplments RedirectsMiddleware so we can override in the VDC middleware
// A PR is needed to update the RedirectsMiddleware to allow for this
 ...
 */
export class RedirectsMiddlewareBase extends MiddlewareBase {
